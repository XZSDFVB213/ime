...
@Component({
  ...
  templateUrl:
    './student-subjects-details.html',

  styleUrl:
    './student-subjects-details.scss',
})
export class StudentSubjectDetails {
  ...
  /*
   * Источник истины —
   * назначенные студенту дисциплины.
   *
   * Не пытаемся определять существование
   * дисциплины по наличию занятий или ДЗ.
   */
  ...
  materialUrl(
    ...
    return `${environment.api}${material.url}`;
  }
