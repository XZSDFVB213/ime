...
export class TeacherCreateLesson {
  ...
  submit(): void {
    ...
    if (
      ...
      this.snackBar.open(
        'Укажите корректную дату занятия',
        'Закрыть',
        {
          duration: 3000,
        },
    ...
    forkJoin({
      ...
      .subscribe({
        ...
        error: (error) => {
          ...
          this.error.set(
            'Не удалось загрузить данные для создания занятия',
          );
        },
      });
  }
